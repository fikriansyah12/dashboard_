...
<div class="container-fluid">
    ...
    {{-- <div class="d-sm-flex align-items-center justify-content-center mb-4">
        <h1 class="h3 mb-0 text-gray-900">Dashboard Requirment</h1> --}}
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card shadow h-100 py-8">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">BULAN
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-success">Skala peningkatan</h6>
...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800 d-flex justify-content-center">Tables</h1>
                ...
                <table class="table table-bordered" id="datatables" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>2011/04/25</td>
                            <td>$320,800</td>
                            <td>   <a href="" class="btn btn-warning">hapus</a>
                        ...
                        <tr>
                            ...
                            <td>2008/11/28</td>
                            <td>$162,700</td>
                            <td>   <a href="" class="btn btn-success">hapus</a>
